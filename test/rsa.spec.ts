...
describe('RSA', () => {
  ...
  test('Should get hardcoded signature', () => {
    const hardcodedSignature =
      'yBZe9REcRPrDFSvB7iMl8uIzMGAAD/rqKpO0r8e2e9UziShAR3w96IUP+yC1N+Ape6EjeTyHbsHuKTNID/fqaA==';
    const msg = 'hello world';
    const privatePem =
      '-----BEGIN RSA PRIVATE KEY-----\n' +
      'MIIBOwIBAAJBAOoxJRf+ya3C6VR2S26WgIbDmIh7M5DGSjIi4mUJoD0c2bsmyI8/\n' +
